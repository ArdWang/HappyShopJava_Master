...
public class RegisterPresenter extends BasePresenter<RegisterView> {
    ...
    public void register(String phone, String pwd,String verifyCode, LifecycleProvider<ActivityEvent> lifeProvider) {
        ...
        //显示加载对话框
        mView.showLoading();
        userRepository.regUser(phone,pwd,verifyCode,lifeProvider).subscribe(new BaseObserver<Boolean>(mView){
            @Override
